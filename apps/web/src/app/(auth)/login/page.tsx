  ...
  return (
    <div className="bg-white border border-[#e2e8f7] rounded-3xl p-6 sm:p-10 shadow-sm space-y-6">
      ...
      <button
        ...
        className="w-full py-3 px-4 rounded-xl border border-[#e2e8f7] bg-white hover:bg-[#f2f4f2] text-[#191c1b] text-xs font-bold transition flex items-center justify-center gap-2.5 shadow-sm"
      >
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-[11px] text-[#515f5d] font-semibold uppercase">Or email</span>
        <div className="flex-1 h-px bg-[#e2e8f7]" />
      </div>
